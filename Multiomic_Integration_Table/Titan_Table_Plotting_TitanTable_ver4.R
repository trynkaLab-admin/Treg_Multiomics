...
df <- read.table("Summary_table_Test_LeadSlope_NoAllNAs.txt", sep="\t", header = TRUE, stringsAsFactors = FALSE)
...
###Write to file
write.table(df, file="Summary_table_Test_LeadSlope_NoAllNAs_Processed.txt", sep="\t", quote = FALSE, row.names = FALSE)
...
df <- read.table(file="Summary_table_Test_LeadSlope_NoAllNAs_Processed.txt", sep="\t", header = TRUE)
...
write.table(df, file = "Summary_table_Test_LeadSlope__NoAllNA_WithSlopeScore.txt", sep="\t", row.names = FALSE, quote = FALSE)

######Loading once written

df <- read.table(file = "Summary_table_Test_LeadSlope__NoAllNA_WithSlopeScore.txt", sep = "\t", header = TRUE)
...
write.table(df8, file = "Categories.txt", sep="\t", quote = FALSE, row.names = FALSE)

###PLotting Snp categories
df9 <- df3
...
df10$Selection <- c("No_Focus","No_Focus","Focus","Focus", "No_Focus", "Focus", "No_Focus")
...
ggsave("SNP_categories.pdf", plot = last_plot(), width = 12, height = 10, units = "in",
...
png("All_FunctionalCategories.png", height = 20, width = 25, units = c("cm"), res = 300)
...
png("In_K4me3Peak.png", height = 20, width = 25, units = c("cm"), res = 300)
...
png("Lead_LDBLOCK_FunctionalCategories.png", height = 20, width = 25, units = c("cm"), res = 300)
...
png("SNP_NO_Lead_LDBLOCK_FunctionalCategories.png", height = 20, width = 25, units = c("cm"), res = 300)
...
png("Lead_LDBLOCK_FunctionalCategories_Selection.png", height = 20, width = 25, units = c("cm"), res = 300)
...
png("SNP_NO_Lead_LDBLOCK_FunctionalCategories_Selection.png", height = 20, width = 25, units = c("cm"), res = 300)
